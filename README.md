...
cargo test                   # 134 tests, includes interpreter-vs-VM differential suite
```
...
| `examples/sized.kupl` | sized integers `i8`…`u64` — literal suffixes, checked arithmetic, conversions |
...
~19,900 lines of dependency-free Rust, 134 tests, all engines differentially
