...
**Version:** 0.3.0 · first audited 2026-07-04 · **refreshed after enrichment
...
- **KUPL v0.3.0 is a real, complete, four-engine toolchain** — REPL,
...
Ratings are 0–5 for the language *as it exists today* (KUPL = v0.3.0, not
...
in a v0.3.0. It trails Rust only because rust-analyzer/clippy/the crates
...
**What KUPL is, today (v0.3.0):** the only language with AI as a
